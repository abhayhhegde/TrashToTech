...
export const getLevel = (totalPoints) => {
  ...
  if (totalPoints >= 5000) {
    return { 
      ...
      description: "You are an e-waste hero! (~20+ Laptops saved)" 
    };
  }
  ...
  if (totalPoints >= 2000) {
    return { 
      ...
      description: "Amazing impact! (~10+ Laptops saved)" 
    };
  }
  ...
  if (totalPoints >= 500) {
    return { 
      ...
      description: "Solid effort! (~7 Smartphones saved)" 
    };
  }
  ...
  if (totalPoints >= 100) {
    return { 
      ...
      description: "Good start! (~2 Smartphones saved)" 
    };
  }
